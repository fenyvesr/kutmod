...
\begin{minipage}{\linewidth}
	\begin{multicols*}{2}
		...
		Several other efforts to give C a formal semantics have been made, most notably by Charles McEwen Ellison (III.). His executable formal semantics of the C language successfully passes  99.2\% of 776 test programs \cite{Ellison:2012:EFS:2103621.2103719} \cite{kutmod}. Since \gls{MISRA} C does not 
	\end{multicols*}
\end{minipage}
